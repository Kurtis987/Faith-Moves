angular.module('FaithMovesApp', ['ngRoute', 'RouteControllers', 'NavbarDirective'])
	.run(function($rootScope) {
		...
		$rootScope.verses[30] = ["Matthew 11:25-30",'At that time Jesus said, <span style="color:red;">“I praise you, Father, Lord of heaven and earth, because you have hidden these things from the wise and learned, and revealed them to little children. 26 Yes, Father, for this is what you were pleased to do. 27 All things have been committed to me by my Father. No one knows the Son except the Father, and no one knows the Father except the Son and those to whom the Son chooses to reveal him. 28 Come to me, all you who are weary and burdened, and I will give you rest. 29 Take my yoke upon you and learn from me, for I am gentle and humble in heart, and you will find rest for your souls. 30 For my yoke is easy and my burden is light.”</span>'];
		...
		$rootScope.verses[34] = ["Luke 6:36","<span style='color:red;'>Be merciful, just as your Father is merciful.</span>"];
		...
		//pick random verse from array
		var pick = Math.floor((Math.random() * $rootScope.verses.length));
