angular.module('RouteControllers', [])
	...
	.controller('SongsController', function($scope, $location) {
		...
		$scope.lyrics[1] = ["Dominic Balli - Drink for Free",'"Drink for Free" Lyrics \n' +
		...
		$scope.lyrics[2] = ["Dominic Balli - Arise",'"Arise" Lyrics \n'+	
			"by Dominic Balli | from the album Public Announcement \n" +
			"  \n" +
			" \n" +
		...
		$scope.lyrics[4] = ["Morgan Heritage - Take up your cross","I've seen the Son of Man, you know he's going there \n"+
			"\n"+
		...
		$scope.lyrics[5] = ["Bunny Rugs - Praise Him","Written by: Bunny Rugs and Dan Geary \n"+
		...
		$scope.lyrics[6] = ["George Nooks - God is Standing By","Lyrics for God Is Standing By by George Nooks \n"+
			" \n"+
		...
		$scope.lyrics[7] = ["Tashai Houston - Sheltered in the arms of God","I feel the touch of hands so warm and tender \n"+
		...
		$scope.lyrics[8] = ["Sam Cooke and the Soul Stirrers - Touch the hem of his garment",
		...
		$scope.lyrics[9] = ["Sam Cooke and the Soul Stirrers - the last mile of the way",
		...
		$scope.lyrics[10] = ["Sam Cooke and the Soul Stirrers - That's heaven to me",
		...
		$scope.lyrics[11] = ["Sam Cooke and the Soul Stirrers - Pilgrim of Sorrow",
		...
		$scope.lyrics[12] = ["Sam Cooke and the Soul Stirrers - He's so wonderful",
		...
		$scope.lyrics[13] = ["The Blind Boys of Alabama -  Wade in the Water",
			"Wade in the water \n"+ 
			"Come on and \n"+
		...
		$scope.lyrics[14] = ["The Blind Boys of Alabama - People Get Ready",
			"People get ready \n"+
		...
		$scope.lyrics[15] = ["The Blind Boys of Alabama - Amazing Grace",
		...
		$scope.lyrics[16] = ["Away From You -The O.C. Supertones",
		...
		$scope.lyrics[17] = ["George nooks - How Great Thou Art",
		...
		$scope.lyrics[18] = ["George Nooks - Give Thanks",
			"Give thanks \n"+
		...
		$scope.lyrics[19] = ["Wayne Stoddart - highest praise",
		...
		$scope.lyrics[21] = ["Avion Blackman - Got To Be",
		...
		$scope.lyrics[22] = ["Avion Blackman - Joy Of The Lord",
			"I can't explain \n"+
		...
		$scope.lyrics[23] = ["Avion Blackman - Day And Night",
		...
		$scope.lyrics[24] = ["Avion Blackman - It Is For Freedom",
		...
		$scope.lyrics[25] = ["PApa San - God and I",
