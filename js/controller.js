angular.module('RouteControllers', [])
	...
	.controller('ArtistsController', function($scope, $location, $routeParams) {
		...
		"avion-blackman.html","full", 'Avion Claudette Trudy Henrietta Blackman (born January 30, 1976) '+
		'is a reggae recording artist, and the wife of Christafari front man Mark Mohr. '+
		'She has produced three solo albums as well as providing vocals and bass guitar '+
		'for Christafari since 2003.[1]"'+
		'As a child she led a humble and simple life. From the age of four to twenty-eight she lived '+
		...
		'they were living on.[4]"'+
		'Christafari'+
		'In 2002, while he was teaching a seminar in Trinidad, Blackman met Christafari founder, '+
		'Mark Mohr and 18 months later they were married in Los Angeles.[5] '+
		...
		'involved with all their subsequent albums and tours.[3]'+
		'Solo career '+
		'Onyinye '+
		'It was during the recording of the Christafari children\'s '+
		...
		' that year (2005).[5][6] The album was released to critical acclaim and at the '+
		...
		'(for the song "Marvelous Beauty").[7] She was the first non-Jamaican to receive the award.[3]'+
		'Sweet life '+
		'In 2008, the follow up album, Sweet Life was released, '+
		'showing a move towards more reggae roots.[8] The song "Yeshua" was a favorite and to this '+
		'day Christafari will often close their concerts with this song.[1][3] '+
		'She picked up another Marlin award for the song "Sweet Life".'+
		'Third World girl '+
		'In 2011 work began on Blackman\'s third album, with a month-long trip to Hawaii and an '+
		...
		'the jungles and waterfalls of Hawaii.[5] Themes on the album include '+
		...
		"DJ-Nicholas.html", "full", 'Jamaican born Gospel Reggae Artiste Nicholas Eccleston, '+
		...
		'from Acts 4:12. He is now a passionate follower of Jesus Christ. '+
 		'Nicholas performs in the USA where he now resides; he performed with Deitrick Haddon on '+
 		...
 		'Tamela Mann among others.'+
		'Nicholas is featured on Grammy nominated singer Deitrick Haddon’s album titled '+
		...
		'Things Already Better, Naa Bow and Cut It Off to name a few."[1] \n\n'+
		...
		"dominic-balli.html", "full", 'When hearing about Dominic Balli\'s story,'+
		'I think about 2 Corinthians 12:9-10. "But he said to me, \'My grace is sufficient for you,'+ 
		...
		'Similarly, Balli attributes strengths of his musical gifts to God, '+
		...
		'and then one day it was like, Here. This is yours. Use it.’”[1] '+
		'It is refreshing that he see\'s himself more as a conduit for the Holy Spirit '+
		...
		"george-nooks.html", "square", '"Nooks started his musical career in the youth choir at his church,'+ 
		'and moved on to perform at school concerts and talent shows.'+ 
		'After first recording professionally in 1974, Nooks first found success performing under '+
		'the name Prince Mohamed, as a deejay on discomix tracks for producer Joe Gibbs.[1] \n\n'+	
		'He continued to have a successful career in the Reggae Market for the next 27 years. However, '+
		'Nooks began to record primarily gospel material after death of his grandmother in 2001. '+
		'[1] He has seen much success in the gospel reggae genre as well.'+
		'His 2016 album Ride Out Your Storm reached number 4 on the Billboard Reggae Albums chart, '+
		'and number 22 on the Gospel chart.'+
		...
		"oc-supertones.html", "full", 'The O. C. Supertones are a Christian ska group that uses music'+ 
		...
		'message is to encourage the Body of Christ and to reach non-believers.  '+
		'The 6 current members all serve at their local churches and 4 of them are full time Pastors. \n\n'+
		'The Supertones have produced 10 albums combining over 1 million units sold, '+
		...
		"papa-san.html", "square", '"Tyrone Thompson, (born July 1, 1967)[1][2][3] better known as Papa San, '+
		'is a Jamaican reggae, dancehall and gospel singer. Born in 1967 in Spanish Town,[4] he was raised '+
		'by his Rastafarian grandmother and began performing with sound systems (including Black Scorpio '+
		'and Creation) in the late 1970s.[5] He won the Tastee Talent contest in 1981.[5] He went on to '+
		...
		'and he himself had legal problems after being arrested on weapons charges.[6] He turned to '+
		'Christianity in 1997.[4] This is also reflected in his style, as he started off as a true '+
		'dancehall deejay, later adopting traits of Gospel and Christian music.[2][3][8][9]'+
		'Papa San sponsors a concert known as Papa San and Friends, to raise funds for orphanages '+
		'in rural Jamaica. Since becoming a Christian he has continued to produce his roots reggae sound, '+
		'but with the message of Christ to the beat instead of his previously popular secular music.'+
		'He has six children and lives in Weston, Florida with five of them and his wife, '+
		'Debbie Thompson. In 2011, Papa San and his wife, having been ordained ministers of the Gospel, '+
		'were launched into pastoral ministry and started Our Fathers Kingdom International Ministries.\n\n'+
		'In 2013, Papa San featured on Church Clothes, Vol 2 by Christian Hip Hop artist Lecrae, '+
		'with Andy Mineo, on the song "The Fever". His album One Blood topped the Billboard Reggae '+
		'Albums Chart in February 2014.[10]\n\n'+
		...
		"sam-cooke-and-the-soul-stirrers.html", "square", '"The Soul Stirrers are an American gospel music group, '+
		'whose career spans over eighty years. The group was a pioneer in the development of the quartet'+
		' style of gospel, and a major influence of soul music, doo wop, and motown sound, some of the secular music that owed much to gospel.'+
		'The group was formed by Roy Crain, who had launched his first quartet, which sang in a '+
		...
		'Rebert Harris, also from Trinity, Texas, brought several changes to the Soul Stirrers '+
		...
		'the Soul Stirrers, while still called a quartet, to acquire five members.'+
		'The Soul Stirrers made other important changes in those years: ad-libbing lyrics, '+
		...
		'individual singers within the group more space for individual development.'+
		'The Soul Stirrers signed with Specialty Records, where they recorded a number of tracks, '+
		...
		'Cooke joined the group at the age of nineteen served as lead vocalist from 1950 to 1956.[1]'+
		'One of the early singles with Cooke was "Jesus Gave Me Water", '+
		'a major hit that brought the Soul Stirrers acclaim. '+
		'Thomas L. Breuster was replaced by Bob King and, briefly, Julius Cheeks. '+
		...
		'Johnnie Taylor sustained the group for a time. '+
		'Various line-ups continued touring and recording throughout the last half of the century '+
		...
		'Early Influences, and into the Vocal Group Hall of Fame in 2000."\n\n'+
		'"The Soul Stirrers" 2018, January 2 Retrieved 2018, https://en.wikipedia.org/wiki/The_Soul_Stirrers'];
		...
		"tashai-houston.html", "full", 'Tashai Houston was born March 15,'+
		...
		'worship leader."[1]\n\n'+
		'“I came from humble beginnings but I know God called me to be a music minister and his call comes '+
		'with provision so I waited patiently on Jehovah Jireh and now the fullness of time has come”'+
		'were the psalmist’s remarks to this new recording stage of her life."[1]'+
		...
		'Tashai believes "love is the key to unlock every closed door. '+
		'Perfect love represents God because God is love and a heart of love is necessary '+
		'for a minister to be truly effective." [1] \n\n'+
		...
		"blind-boys-of-alabama.html", "full", 'The Blind Boys first rose to fame in the segregated '+
		...
		'"The band\'s original lineup is down to just two remaining survivors: long-time group '+
		...
		'the album. \n\n'+
		'"These men were both raised as blind, African American males in the Deep South during '+
		...
		'"But they\'ve transcended all that."'+
 		'Given the age of the surviving original members, it\'s not hard to hear the subtext of '+
 		...
 		'spreading peace, joy, and love until the very last note.\n\n'+
		...
		"wayne-stoddart.html", "square", '"Wayne Stoddart, as a young adult, lived in the inner-city '+
		...
		'Performing Gospel Band by the Jamaica Music Awards (JAMI) for the FULFILLMENT album.'+
		'Wayne Stoddart debut solo album COMMITTED was nominated Best New Gospel Reggae album and '+
		...
		'releases his third solo album IT IS WRITTEN in 2015. The album contains 13 original '+
		'songs and one dub; all lyrics written by Wayne Stoddart. '+
		'“I like to think of my music as Righteous Rockers…music is my expression of life '+
		...
		'the songwriter passionately expressed.'+
		'The gospel reggae phenomenon continues to feed the people with the '+
		...
		"carlene-davis.html", "square", 'Carlene Davis (born c.1953) is a Jamaican gospel and reggae singer '+
		...
		'She has released over ten albums.'+
		'Davis was born in Colonels Ridge, Clarendon Parish and moved to England with her parents at the '+
		'age of fourteen, where she began to perform professionally a year later, playing guitar '+
		'in an all-girl band before joining the pop trio Toreadores.[2] She then moved to Toronto, '+
		'Ontario, Canada where she lived for eight years.[3] Davis initially found fame as a reggae '+
		'singer. She recorded her debut single in Toronto, a version of "Leaving on a Jet Plane",[2] '+
		'and had a local hit with a version of Jimmy Cliff\'s "The Harder They Come".[4]'+
		'In 1996 she was diagnosed with breast cancer and her Christian faith became a more '+
		'important part of her life.[12] She returned to recording gospel music, '+
		...
		'countries.[7] She became involved in cancer charity work, with half of the proceeds '+
		'from her 2003 album Author and Finisher going to the Jamaica Cancer Society.[13] '+
		'Davis has continued to perform regularly, including appearances at the Redbones Blues '+
		'Revue,[14] Fun in the Son,[15] and Live On The Waterfront.[16]'+
		'In 2000, Davis was named Minister of music for The Family Church on the Rock in Kingston.[7] '+
		'In 2006 she gained a doctorate in pastoral counselling from the Trinity Theological Seminary '+
		'in South Florida.[6]'+
		'By the mid-2000s Davis had her own recording studio, Judah Recording, and the Glory Music '+
		'productions record label, run with her husband Tommy Cowan.[10]'+
		'In 2014 Davis released the album Dripping Blood, and announced that 25 percent of '+
		'royalties would go to US-based charity Samaritan\'s Purse to fund their work fighting '+
		'Ebola in Liberia.[17] The album reached number 3 on the Billboard Reggae Albums chart.[18]"\n\n'+
		...
		"donna-marie.html", "square", 'Donna Marie was born in the UK, although her formative years were '+
		...
		'lead and backing vocals." As a soloist she had Gospel Reggae songs ... featured on the Album ...\n\n'+
		...
		'URIAH, which he formed in the mid 1980’s.</p>'+
		...
		'God had given him to the work of the Ministry. </p>'+
		...
		'involves children of mixed abilities and Special Needs. </p>'+
		'<p>Owen is confident about his calling to the Ministry, and his position in the Body of Christ.</p>'+
		...
		'individuals to find their position and walk the path that is set before them.”</p>'+
		...
		'that we all face.</p>'+
		'<p>He directs the listener to Jesus Christ, the Author and Finisher of our Faith.</p>'+
		'<p> Owen is committed to the message that is promoted in his music, and conveys an '+
		'uncompromising message about his Lord and Saviour, Jesus Christ.</p>'+
		'<h4> MINISTRY</h4>'+
		'<p>In 1992 Owen began singing at National and International Evangelistic Crusades and Major '+
		'Christian conferences. He has toured the U.S.A, Jamaica and Europe. </p>'+
		'<p>He is humble and very approachable, and seeks to be a blessing wherever he goes. '+
		'His ability to communicate and encourage has enabled him to be effective in the Ministries.</p>'+
		'<p>He has attended Bible College in Birmingham, England, and has also studied in the U.S.A.</p>'+
		'<p>He also has a Teaching Ministry. He has a grounded approach to his Ministry as he encourages '+
		'others to adopt the motto: “KEEP IT REAL.”</p>'+
		'<h4>COMMUNITY SERVICES.</h4>'+
		'<p>Owen is also actively involved in prison ministry in conjunction with the United Evangelical '+
		'Project visiting prisons throughout the U.K.</p>'+
		'<p>He has been a fundraiser for the National Society for Prevention of Cruelty to Children '+
		'for over six years. He has organised major events, raising funds for numerous charitable bodies. </p>'+
		'<p>He also works with the Youth Offending Service as a Community Panel member, administering '+
		'Referral Orders to young offenders in liaison with Birmingham Juvenile Court in England.</p>'+
		'<p>He is a Registered Learning Mentor, with youth at local schools throughout Birmingham, England.</p>'+
		'<p>He is a Black Belt Karate Instructor with the English Karate Governing Body. His Karate '+
		'School has achieved Gold, Silver and Bronze medals in National and International Events.</p>'+
		'<p>He was also an International Association Coach and England Karate Judge.</p>'+
		...
		'Army contributing to Birmingham’s Homeless.</p>'+
